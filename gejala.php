    ...
    <form method="post">
      <div class="col-sm-8 text-left">
          <div class="form-group"  method="POST">
              <label class="control-label label-id">ID Gejala :</label>
              <div>
...
function add(){
  $('.table').empty();
  $(".content-data-kerusakan").empty().append(`      
    <h2 class="ui header">Tambah Data Gejala</h2>
    <form method="post">
      <div class="col-sm-8 text-left">
...
<?php
  ...
  if(isset($_POST['edit'])){
    ...
    $query1=$query1="update gejala SET gejala='".$_POST['nama-kerusakan']."' WHERE idgejala='$id'";
  ...
  if(isset($_POST['add'])){
    ...
    $query1=$query1="INSERT INTO gejala VALUES ( 'G$id','".$_POST['nama-kerusakan']."')";
    mysqli_query($konek_db, $query1);
